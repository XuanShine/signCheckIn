...
DB_FOLDER = os.environ.get("DATABASE_FOLDER", required_folder(APP_FOLDER, "databases"))
...
SESSION_SECRET_KEY = "test_secret_key_for_development"  # or replace with your own secret
